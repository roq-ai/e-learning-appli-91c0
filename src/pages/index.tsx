  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="E-learning Application - Transforming the Future of Education with our Innovative Digital Assessment Solution"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkaWdpdGFsfGVufDB8fHx8MTY5NTQ0MDI5Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`E-learning Application - Transforming the Future of Education with our Innovative Digital Assessment Solution`}
            </Text>
            <Box
