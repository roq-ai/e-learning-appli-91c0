...
import { getUserAssessmentById } from 'apiSdk/user-assessments';
import { UserAssessmentInterface } from 'interfaces/user-assessment';

function UserAssessmentViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('user_assessment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/user-assessments/edit/${id}`} passHref legacyBehavior>
                    <Button
