...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'AssessmentCreated.create': { roles: ['administrator'], key: 'Assessment', tenantPath: [], userPath: [] },
  'ContentUpdated.update': { roles: ['administrator', 'assessor'], key: 'Content', tenantPath: [], userPath: [] },
  'UserRoleUpdated.update': { roles: ['administrator'], key: 'User', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['administrator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['administrator', 'assessor', 'content-creator'];
